<template>
  <div>
    ...
    <v-card-text
      >Jan Orbanz<br />
      Franklinstrasse 15<br />
      01069 Dresden</v-card-text
    >
    <v-card-subtitle>Kontakt</v-card-subtitle>
    <v-card-text
      >Telefon: 015226187201<br />
      E-Mail: info@werace.de</v-card-text
    >
    <v-card-subtitle>Haftung für Inhalte</v-card-subtitle>
    <v-card-text
      ...
      umgehend entfernen.</v-card-text
    >
    <v-card-subtitle>Haftung für Links</v-card-subtitle>
    <v-card-text
    ...
    >
    <v-card-subtitle>Urheberrecht</v-card-subtitle>
    <v-card-text
      ...
      Urheberrechtes bedürfen der schriftlichen Zustimmung des jeweiligen Autors bzw. Erstellers. <br /><br />
      Downloads und Kopien dieser Seite sind nur für den privaten, nicht kommerziellen Gebrauch gestattet.
      <br /><br />
      Soweit die Inhalte auf dieser Seite nicht vom Betreiber erstellt wurden, werden die Urheberrechte Dritter
      beachtet. Insbesondere werden Inhalte Dritter als solche gekennzeichnet. Sollten Sie trotzdem auf eine
      Urheberrechtsverletzung aufmerksam werden, bitten wir um einen entsprechenden Hinweis. Bei Bekanntwerden von
      Rechtsverletzungen werden wir derartige Inhalte umgehend entfernen.</v-card-text
    >
  </div>
</template>
